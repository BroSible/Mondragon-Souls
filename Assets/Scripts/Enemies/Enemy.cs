...
public class Enemy : MonoBehaviour
{
    ...
    [SerializeField]
    protected bool _isAlreadyAttacked;

    [SerializeField]
    protected bool _isAttackInProgress = false; // Флаг для отслеживания выполнения атаки

    [SerializeField]
    protected bool _hasBeenTargeted;

    [SerializeField]
    public static bool _isParried = false; // Индивидуальная переменная для каждого врага
    ...
    [SerializeField]
    private LayerMask _obstacleMask; // Слой препятствий
